...
class Pinjaman
{
    ...
    function create(){
        ...
        $query = "INSERT INTO
                    " . $this->table_name . "(pinjaman_id, tanggal, angsuran_ke, jumlah_bayar, keterangan)
                VALUES(
                    :pinjaman_id, :tanggal, :angsuran_ke, :jumlah_bayar, :keterangan)";
    ...
    function readOne() {
        ...
        $this->id = $row['id'];
        $this->debitur_id = $row['pinjaman_id'];
        $this->tanggal = $row['tanggal'];
        $this->jumlah_angsuran = $row['angsuran_ke'];
        $this->jumlah_pinjaman = $row['jumlah_bayar'];
        $this->input_date = $row['keterangan'];
    }
